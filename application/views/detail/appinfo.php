            ...
            <div class="container">
                <div class="top-body">
                    <div class="left select-device">
                        <a href="javascript::void(0)" class="mobile active">Details</a>
                        <a href="javascript::void(0)" class="">Ratings and Reviews</a>
                        <a href="javascript::void(0)" class="tablet">Related</a>
                    </div>
                ...
                <div class="under-body seperate">
                    ...
                    <div class="main-body col-lg-9">
                        <div class="first-list app-list">
                            <h1 id="first-list-name">Top free Apps</h1>
                            <div class="row">
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/2.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                ...
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/3.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                      <p><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star-half-full fa-fw"></i><i class="fa fa-star-o fa-fw"></i></p>
                                      <p><i>Games</i></a>
                                ...
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/4.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                      <p><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star-half-full fa-fw"></i><i class="fa fa-star-o fa-fw"></i></p>
                                      <p><i>Games</i></a>
                                ...
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/5.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                      <p><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star-half-full fa-fw"></i><i class="fa fa-star-o fa-fw"></i></p>
                                      <p><i>Games</i></a>
                    ...
                    <div class="second-list app-list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/8.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                      <p><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star-half-full fa-fw"></i><i class="fa fa-star-o fa-fw"></i></p>
                                      <p><i>Games</i></a>
                    ...
                    <div class="third-list app-list">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/6.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                      <p><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star-half-full fa-fw"></i><i class="fa fa-star-o fa-fw"></i></p>
                                      <p><i>Games</i></a>
                                ...
                                <div class="col-sm-3 col-md-2">
                                  <div class="thumbnail">
                                      <img src="<?php echo base_url()?>icon/7.png" alt="...">
                                    <div class="caption">
                                      <h3>Winrunner</h3>
                                      <p><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star fa-fw"></i><i class="fa fa-star-half-full fa-fw"></i><i class="fa fa-star-o fa-fw"></i></p>
                                      <p><i>Games</i></a>
