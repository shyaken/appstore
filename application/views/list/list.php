        ...
        <div class="under-body seperate">
            <div class="left-body col-lg-3">
                ...
                <div class="category-list suggested-app">
                    <h1>TOP FREE APPS</h1>
                    <div class="media">
                        <a class="pull-left" href="<?php echo base_url() ?>detail/1">
                            <img class="media-object" src="<?php echo base_url() ?>icon/1.png" alt="">
                        </a>
                        <div class="media-body">
                            <h2 class="media-heading">Asphalt Override</h2>
                            Games
                        </div>
                    </div>
                    <div class="seperate"></div>
                    <div class="media">
                        <a class="pull-left" href="<?php echo base_url() ?>detail/2">
                    ...
                    <div class="seperate"></div>
                    <div class="media">
                        <a class="pull-left" href="<?php echo base_url() ?>detail/3">
                    ...
                    <div class="seperate"></div>
                    <div class="media">
                        <a class="pull-left" href="<?php echo base_url() ?>detail/4">
